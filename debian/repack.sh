...
# Hack to get BZR revision out of upstream package source. If this version info
# is of real interest then it should be in the VERSION file
...
echo "PERCONA_SERVER_FULLNAME=${PERCONA_SERVER_FULLNAME}" >> ${SOURCE_TAR_DIR}/DEB-VERSION
echo "PERCONA_SERVER_DEBNAME=${PERCONA_SERVER_DEBNAME}" >> ${SOURCE_TAR_DIR}/DEB-VERSION
echo "BZR_REVISION=${BZR_REVISION}" >> ${SOURCE_TAR_DIR}/DEB-VERSION
echo "HTTP_LOCATION=${HTTP_LOCATION}" >> ${SOURCE_TAR_DIR}/DEB-VERSION
